...
with app.app_context():
    ...
    # Add sample pet data
    pet1 = Pet(name='Buddy', species='Dog', breed='Labrador', age=3, gender='Male', size='Medium', image_url='https://example.com/buddy.jpg')
    ...
    today = datetime.now()
    adoption1 = Adoption(pet_id=pet1.id, adopter_name='John Doe', adoption_date=today - timedelta(days=30))
    adoption2 = Adoption(pet_id=pet2.id, adopter_name='Jane Smith', adoption_date=today - timedelta(days=45))
    adoption3 = Adoption(pet_id=pet3.id, adopter_name='Bob Johnson', adoption_date=today - timedelta(days=60))
    adoption4 = Adoption(pet_id=pet4.id, adopter_name='Sarah Lee', adoption_date=today - timedelta(days=75))
    adoption5 = Adoption(pet_id=pet5.id, adopter_name='Tom Wilson', adoption_date=today - timedelta(days=90))
    adoption6 = Adoption(pet_id=pet6.id, adopter_name='Emily Davis', adoption_date=today - timedelta(days=105))
    adoption7 = Adoption(pet_id=pet7.id, adopter_name='Alex Garcia', adoption_date=today - timedelta(days=120))
    adoption8 = Adoption(pet_id=pet8.id, adopter_name='Olivia Martinez', adoption_date=today - timedelta(days=135))
    adoption9 = Adoption(pet_id=pet9.id, adopter_name='Michael Fernandez', adoption_date=today - timedelta(days=150))
    adoption10 = Adoption(pet_id=pet10.id, adopter_name='Sophia Reyes', adoption_date=today - timedelta(days=165))
